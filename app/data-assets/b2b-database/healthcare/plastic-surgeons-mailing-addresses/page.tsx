...
export const metadata: Metadata = {
  title: "Plastic Surgeons Mailing Addresses · Healthcare B2B Database — Lorann LLC",
  description:
    "Board-certified US plastic and reconstructive surgeons with practice-level firmographics. Verified monthly.",
};
...
const CRUMBS = [
  { label: "Home", href: "/" },
      ...
      { label: "Plastic Surgeons Mailing Addresses" },
];

const STATS = [
  { label: "Total Records", value: "9,500+" },
...
const ATTRIBUTES = [
  { Icon: Mail, title: "Verified Email", desc: "Continuously validated email for plastic surgeon contacts with bounce-rate control." },
    ...
    { Icon: Stethoscope, title: "Specialty Code", desc: "Plastic surgery sub-specialty segmentation tagged at record level." },
...
export default function PlasticSurgeonsMailingAddressesPage() {
  return (
    <LeafPage
      crumbs={CRUMBS}
      kicker="Healthcare List"
      titlePlain="Plastic Surgeons —"
      titleAccent="board-certified, practice-mapped."
      description="Board-certified plastic and reconstructive surgeons across the United States — with practice-level firmographics, specialty focus, and aesthetic vs reconstructive tagging."
      stats={STATS}
      intro={{
        kicker: "Why this list",
        headlinePlain: "A specialty list built for",
        headlineAccent: "device, aesthetic, and product marketers.",
        paragraphs: [
          "Plastic surgery marketing requires absolute precision — the wrong target wastes a campaign budget. Our Plastic Surgeons Mailing Addresses list covers 9,500+ board-certified plastic and reconstructive surgeons with aesthetic-versus-reconstructive practice tagging.",
      "Built for aesthetic device marketing, injectable launches, surgical product introductions, practice-management platforms, and post-surgery patient program partners.",
        ],
      }}
