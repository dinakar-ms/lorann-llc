...
export const metadata: Metadata = {
  title: "Microsoft Windows Users · Technology B2B Database — Lorann LLC",
  description:
    "Companies running Microsoft Windows — verified user list with role, seniority, and firmographic depth.",
};
...
const STATS = [
  { label: "Total Records", value: "850K+" },
...
const ATTRIBUTES = [
  { Icon: Mail, title: "Verified Email", desc: "Continuously validated email for deliverability and bounce control." },
    ...
    { Icon: Cpu, title: "Tech Stack", desc: "Confirmed use of Microsoft Windows flagged at the company level." },
...
export default function MSCustomersListPage() {
  return (
    <LeafPage
      crumbs={CRUMBS}
      kicker="Technology List"
      titlePlain="Microsoft Customers List —"
      titleAccent="Windows-using companies."
      description="Companies running Microsoft Windows operating systems — segmented by deployment scale, industry, and supporting Microsoft stack components."
      stats={STATS}
      intro={{
        kicker: "Why this list",
        headlinePlain: "Reach Microsoft Windows users",
        headlineAccent: "with installed-base precision.",
        paragraphs: [
          "Microsoft Windows marketing requires installed-base precision. Whether you\u2019re selling complementary tools, running a migration program, or targeting competitive displacement, the list needs to be platform-specific and role-aware.",
      "Our Microsoft Windows user list is verified to the same standard as every Lorann file: monthly verification, opt-in compliant, and segmented by role and seniority across decision-making teams.",
        ],
      }}
