...
export const metadata: Metadata = {
  title: "Unix Users · Technology B2B Database — Lorann LLC",
  description:
    "Companies running Unix — verified user list with role, seniority, and firmographic depth.",
};
...
const ATTRIBUTES = [
  { Icon: Mail, title: "Verified Email", desc: "Continuously validated email for deliverability and bounce control." },
    ...
    { Icon: Cpu, title: "Tech Stack", desc: "Confirmed use of Unix flagged at the company level." },
...
export default function UnixUsersMailingDataPage() {
  return (
    <LeafPage
      crumbs={CRUMBS}
      kicker="Technology List"
      titlePlain="Unix Users Mailing Data —"
      titleAccent="AIX, Solaris, HP-UX."
      description="Companies running enterprise Unix variants — AIX, Solaris, HP-UX — typically large-enterprise installations across financial services, telco, and manufacturing."
      stats={STATS}
      intro={{
        kicker: "Why this list",
        headlinePlain: "Reach Unix users",
        headlineAccent: "with installed-base precision.",
        paragraphs: [
          "Unix marketing requires installed-base precision. Whether you\u2019re selling complementary tools, running a migration program, or targeting competitive displacement, the list needs to be platform-specific and role-aware.",
      "Our Unix user list is verified to the same standard as every Lorann file: monthly verification, opt-in compliant, and segmented by role and seniority across decision-making teams.",
        ],
      }}
