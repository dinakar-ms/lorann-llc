...
export const metadata: Metadata = {
  title: "IBS Enterprise ERP Users · Technology B2B Database — Lorann LLC",
  description:
    "Companies running IBS Enterprise ERP — verified user list with role, seniority, and firmographic depth.",
};
...
const CRUMBS = [
  { label: "Home", href: "/" },
      ...
      { label: "IBS Enterprise ERP" },
];

const STATS = [
  { label: "Total Records", value: "3K+" },
...
const ATTRIBUTES = [
  { Icon: Mail, title: "Verified Email", desc: "Continuously validated email for deliverability and bounce control." },
    ...
    { Icon: Cpu, title: "Tech Stack", desc: "Confirmed use of IBS Enterprise ERP flagged at the company level." },
...
export default function IBSEnterpriseERPUsersListsPage() {
  return (
    <LeafPage
      crumbs={CRUMBS}
      kicker="Technology List"
      titlePlain="IBS Enterprise ERP —"
      titleAccent="erp user list."
      description="Companies running IBS Enterprise ERP across the United States — verified email contacts with role, seniority, and firmographic depth for installed-base and competitive marketing campaigns."
      stats={STATS}
      intro={{
        kicker: "Why this list",
        headlinePlain: "Reach IBS Enterprise ERP users",
        headlineAccent: "with installed-base precision.",
        paragraphs: [
          "IBS Enterprise ERP marketing requires installed-base precision. Whether you\u2019re selling complementary tools, running a migration program, or targeting competitive displacement, the list needs to be platform-specific and role-aware.",
      "Our IBS Enterprise ERP user list is verified to the same standard as every Lorann file: monthly verification, opt-in compliant, and segmented by role and seniority across decision-making teams.",
        ],
      }}
