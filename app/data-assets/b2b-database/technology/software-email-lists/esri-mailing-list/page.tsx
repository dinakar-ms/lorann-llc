...
export const metadata: Metadata = {
  title: "Esri ArcGIS Users · Technology B2B Database — Lorann LLC",
  description:
    "Companies running Esri ArcGIS — verified user list with role, seniority, and firmographic depth.",
};
...
const ATTRIBUTES = [
  { Icon: Mail, title: "Verified Email", desc: "Continuously validated email for deliverability and bounce control." },
    ...
    { Icon: Cpu, title: "Tech Stack", desc: "Confirmed use of Esri ArcGIS flagged at the company level." },
...
export default function ESRIMailingListPage() {
  return (
    <LeafPage
      crumbs={CRUMBS}
      kicker="Technology List"
      titlePlain="Esri ArcGIS —"
      titleAccent="software user list."
      description="Companies running Esri ArcGIS across the United States — verified email contacts with role, seniority, and firmographic depth for installed-base and competitive marketing campaigns."
      stats={STATS}
      intro={{
        kicker: "Why this list",
        headlinePlain: "Reach Esri ArcGIS users",
        headlineAccent: "with installed-base precision.",
        paragraphs: [
          "Esri ArcGIS marketing requires installed-base precision. Whether you\u2019re selling complementary tools, running a migration program, or targeting competitive displacement, the list needs to be platform-specific and role-aware.",
      "Our Esri ArcGIS user list is verified to the same standard as every Lorann file: monthly verification, opt-in compliant, and segmented by role and seniority across decision-making teams.",
        ],
      }}
