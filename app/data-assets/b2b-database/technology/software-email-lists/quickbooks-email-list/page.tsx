...
export const metadata: Metadata = {
  title: "Intuit QuickBooks Users · Technology B2B Database — Lorann LLC",
  description:
    "Companies running Intuit QuickBooks — verified user list with role, seniority, and firmographic depth.",
};
...
const ATTRIBUTES = [
  { Icon: Mail, title: "Verified Email", desc: "Continuously validated email for deliverability and bounce control." },
    ...
    { Icon: Cpu, title: "Tech Stack", desc: "Confirmed use of Intuit QuickBooks flagged at the company level." },
...
export default function QuickbooksEmailListPage() {
  return (
    <LeafPage
      crumbs={CRUMBS}
      kicker="Technology List"
      titlePlain="Intuit QuickBooks —"
      titleAccent="software user list."
      description="Companies running Intuit QuickBooks across the United States — verified email contacts with role, seniority, and firmographic depth for installed-base and competitive marketing campaigns."
      stats={STATS}
      intro={{
        kicker: "Why this list",
        headlinePlain: "Reach Intuit QuickBooks users",
        headlineAccent: "with installed-base precision.",
        paragraphs: [
          "Intuit QuickBooks marketing requires installed-base precision. Whether you\u2019re selling complementary tools, running a migration program, or targeting competitive displacement, the list needs to be platform-specific and role-aware.",
      "Our Intuit QuickBooks user list is verified to the same standard as every Lorann file: monthly verification, opt-in compliant, and segmented by role and seniority across decision-making teams.",
        ],
      }}
