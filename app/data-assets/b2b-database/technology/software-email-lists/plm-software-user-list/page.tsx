...
export const metadata: Metadata = {
  title: "PLM Software (PTC, Siemens, Dassault) Users · Technology B2B Database — Lorann LLC",
  description:
    "Companies running PLM Software (PTC, Siemens, Dassault) — verified user list with role, seniority, and firmographic depth.",
};
...
const CRUMBS = [
  { label: "Home", href: "/" },
      ...
      { label: "Software Email Lists", href: "/data-assets/b2b-database/technology/software-email-lists" },
      { label: "PLM Software (PTC, Siemens, Dassault)" },
];

const STATS = [
  { label: "Total Records", value: "45K+" },
...
const ATTRIBUTES = [
  { Icon: Mail, title: "Verified Email", desc: "Continuously validated email for deliverability and bounce control." },
    ...
    { Icon: Cpu, title: "Tech Stack", desc: "Confirmed use of PLM Software (PTC, Siemens, Dassault) flagged at the company level." },
...
export default function PLMSoftwareUserListPage() {
  return (
    <LeafPage
      crumbs={CRUMBS}
      kicker="Technology List"
      titlePlain="PLM Software (PTC, Siemens, Dassault) —"
      titleAccent="software user list."
      description="Companies running PLM Software (PTC, Siemens, Dassault) across the United States — verified email contacts with role, seniority, and firmographic depth for installed-base and competitive marketing campaigns."
      stats={STATS}
      intro={{
        kicker: "Why this list",
        headlinePlain: "Reach PLM Software (PTC, Siemens, Dassault) users",
        headlineAccent: "with installed-base precision.",
        paragraphs: [
          "PLM Software (PTC, Siemens, Dassault) marketing requires installed-base precision. Whether you\u2019re selling complementary tools, running a migration program, or targeting competitive displacement, the list needs to be platform-specific and role-aware.",
      "Our PLM Software (PTC, Siemens, Dassault) user list is verified to the same standard as every Lorann file: monthly verification, opt-in compliant, and segmented by role and seniority across decision-making teams.",
        ],
      }}
      ...
      backLink={{ label: "All Software Email Lists Lists", href: "/data-assets/b2b-database/technology/software-email-lists" }}
    />
  );
}
