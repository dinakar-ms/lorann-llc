...
export const metadata: Metadata = {
  title: "Siebel CRM (Oracle) Users · Technology B2B Database — Lorann LLC",
  description:
    "Companies running Siebel CRM (Oracle) — verified user list with role, seniority, and firmographic depth.",
};
...
const CRUMBS = [
  { label: "Home", href: "/" },
      ...
      { label: "Siebel CRM (Oracle)" },
];

const STATS = [
  { label: "Total Records", value: "15K+" },
...
const ATTRIBUTES = [
  { Icon: Mail, title: "Verified Email", desc: "Continuously validated email for deliverability and bounce control." },
    ...
    { Icon: Cpu, title: "Tech Stack", desc: "Confirmed use of Siebel CRM (Oracle) flagged at the company level." },
...
export default function SiebelCRMUsersListPage() {
  return (
    <LeafPage
      crumbs={CRUMBS}
      kicker="Technology List"
      titlePlain="Siebel CRM (Oracle) —"
      titleAccent="crm user list."
      description="Companies running Siebel CRM (Oracle) across the United States — verified email contacts with role, seniority, and firmographic depth for installed-base and competitive marketing campaigns."
      stats={STATS}
      intro={{
        kicker: "Why this list",
        headlinePlain: "Reach Siebel CRM (Oracle) users",
        headlineAccent: "with installed-base precision.",
        paragraphs: [
          "Siebel CRM (Oracle) marketing requires installed-base precision. Whether you\u2019re selling complementary tools, running a migration program, or targeting competitive displacement, the list needs to be platform-specific and role-aware.",
      "Our Siebel CRM (Oracle) user list is verified to the same standard as every Lorann file: monthly verification, opt-in compliant, and segmented by role and seniority across decision-making teams.",
        ],
      }}
