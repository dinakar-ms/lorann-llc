...
export const metadata: Metadata = {
  title: "CRM Users Users · Technology B2B Database — Lorann LLC",
  description:
    "Companies running CRM Users — verified user list with role, seniority, and firmographic depth.",
};
...
const STATS = [
  { label: "Total Records", value: "120K+" },
...
const ATTRIBUTES = [
  { Icon: Mail, title: "Verified Email", desc: "Continuously validated email for deliverability and bounce control." },
    ...
    { Icon: Cpu, title: "Tech Stack", desc: "Confirmed use of CRM Users flagged at the company level." },
...
export default function CRMUsersMailingDataDetailPage() {
  return (
    <LeafPage
      crumbs={CRUMBS}
      ...
      description="Companies running CRM Users across the United States — verified email contacts with role, seniority, and firmographic depth for installed-base and competitive marketing campaigns."
      stats={STATS}
      intro={{
        kicker: "Why this list",
        headlinePlain: "Reach CRM Users users",
        headlineAccent: "with installed-base precision.",
        paragraphs: [
          "CRM Users marketing requires installed-base precision. Whether you\u2019re selling complementary tools, running a migration program, or targeting competitive displacement, the list needs to be platform-specific and role-aware.",
      "Our CRM Users user list is verified to the same standard as every Lorann file: monthly verification, opt-in compliant, and segmented by role and seniority across decision-making teams.",
        ],
      }}
