...
export const metadata: Metadata = {
  title: "Microsoft Dynamics CRM Users · Technology B2B Database — Lorann LLC",
  description:
    "Companies running Microsoft Dynamics CRM — verified user list with role, seniority, and firmographic depth.",
};
...
const CRUMBS = [
  { label: "Home", href: "/" },
      ...
      { label: "CRM Users", href: "/data-assets/b2b-database/technology/crm-users-mailing-data" },
...
const ATTRIBUTES = [
  { Icon: Mail, title: "Verified Email", desc: "Continuously validated email for deliverability and bounce control." },
    ...
    { Icon: Cpu, title: "Tech Stack", desc: "Confirmed use of Microsoft Dynamics CRM flagged at the company level." },
...
export default function MicrosoftDynamicsCRMUsersMailingListPage() {
  return (
    <LeafPage
      crumbs={CRUMBS}
      kicker="Technology List"
      titlePlain="Microsoft Dynamics CRM —"
      titleAccent="crm user list."
      description="Companies running Microsoft Dynamics CRM across the United States — verified email contacts with role, seniority, and firmographic depth for installed-base and competitive marketing campaigns."
      stats={STATS}
      intro={{
        kicker: "Why this list",
        headlinePlain: "Reach Microsoft Dynamics CRM users",
        headlineAccent: "with installed-base precision.",
        paragraphs: [
          "Microsoft Dynamics CRM marketing requires installed-base precision. Whether you\u2019re selling complementary tools, running a migration program, or targeting competitive displacement, the list needs to be platform-specific and role-aware.",
      "Our Microsoft Dynamics CRM user list is verified to the same standard as every Lorann file: monthly verification, opt-in compliant, and segmented by role and seniority across decision-making teams.",
        ],
      }}
      ...
      backLink={{ label: "All CRM Users Lists", href: "/data-assets/b2b-database/technology/crm-users-mailing-data" }}
    />
  );
}
