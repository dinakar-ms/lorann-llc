...
export const metadata: Metadata = {
  title: "OnContact CRM Users · Technology B2B Database — Lorann LLC",
  description:
    "Companies running OnContact CRM — verified user list with role, seniority, and firmographic depth.",
};
...
const ATTRIBUTES = [
  { Icon: Mail, title: "Verified Email", desc: "Continuously validated email for deliverability and bounce control." },
    ...
    { Icon: Cpu, title: "Tech Stack", desc: "Confirmed use of OnContact CRM flagged at the company level." },
...
export default function OnContactCRMCustomersEmailListPage() {
  return (
    <LeafPage
      crumbs={CRUMBS}
      kicker="Technology List"
      titlePlain="OnContact CRM —"
      titleAccent="crm user list."
      description="Companies running OnContact CRM across the United States — verified email contacts with role, seniority, and firmographic depth for installed-base and competitive marketing campaigns."
      stats={STATS}
      intro={{
        kicker: "Why this list",
        headlinePlain: "Reach OnContact CRM users",
        headlineAccent: "with installed-base precision.",
        paragraphs: [
          "OnContact CRM marketing requires installed-base precision. Whether you\u2019re selling complementary tools, running a migration program, or targeting competitive displacement, the list needs to be platform-specific and role-aware.",
      "Our OnContact CRM user list is verified to the same standard as every Lorann file: monthly verification, opt-in compliant, and segmented by role and seniority across decision-making teams.",
        ],
      }}
