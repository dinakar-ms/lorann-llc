...
export const metadata: Metadata = {
  title: "Enterprise databases (broad) Users · Technology B2B Database — Lorann LLC",
  description:
    "Companies running Enterprise databases (broad) — verified user list with role, seniority, and firmographic depth.",
};
...
const CRUMBS = [
  { label: "Home", href: "/" },
      ...
      { label: "Enterprise databases (broad)" },
];
...
const ATTRIBUTES = [
  { Icon: Mail, title: "Verified Email", desc: "Continuously validated email for deliverability and bounce control." },
    ...
    { Icon: Cpu, title: "Tech Stack", desc: "Confirmed use of Enterprise databases (broad) flagged at the company level." },
...
export default function DatabaseUsersMailingListsPage() {
  return (
    <LeafPage
      crumbs={CRUMBS}
      kicker="Technology List"
      titlePlain="Enterprise databases (broad) —"
      titleAccent="business technology user list."
      description="Companies running Enterprise databases (broad) across the United States — verified email contacts with role, seniority, and firmographic depth for installed-base and competitive marketing campaigns."
      stats={STATS}
      intro={{
        kicker: "Why this list",
        headlinePlain: "Reach Enterprise databases (broad) users",
        headlineAccent: "with installed-base precision.",
        paragraphs: [
          "Enterprise databases (broad) marketing requires installed-base precision. Whether you\u2019re selling complementary tools, running a migration program, or targeting competitive displacement, the list needs to be platform-specific and role-aware.",
      "Our Enterprise databases (broad) user list is verified to the same standard as every Lorann file: monthly verification, opt-in compliant, and segmented by role and seniority across decision-making teams.",
        ],
      }}
