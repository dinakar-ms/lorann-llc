...
export const metadata: Metadata = {
  title: "IBM Db2 / IBM Database Users · Technology B2B Database — Lorann LLC",
  description:
    "Companies running IBM Db2 / IBM Database — verified user list with role, seniority, and firmographic depth.",
};
...
const CRUMBS = [
  { label: "Home", href: "/" },
      ...
      { label: "DBMS Users", href: "/data-assets/b2b-database/technology/dbms-users-email-data" },
      { label: "IBM Db2 / IBM Database" },
];

const STATS = [
  { label: "Total Records", value: "65K+" },
...
const ATTRIBUTES = [
  { Icon: Mail, title: "Verified Email", desc: "Continuously validated email for deliverability and bounce control." },
    ...
    { Icon: Cpu, title: "Tech Stack", desc: "Confirmed use of IBM Db2 / IBM Database flagged at the company level." },
...
export default function IBMUsersEmailListPage() {
  return (
    <LeafPage
      crumbs={CRUMBS}
      kicker="Technology List"
      titlePlain="IBM Db2 / IBM Database —"
      titleAccent="dbms user list."
      description="Companies running IBM Db2 / IBM Database across the United States — verified email contacts with role, seniority, and firmographic depth for installed-base and competitive marketing campaigns."
      stats={STATS}
      intro={{
        kicker: "Why this list",
        headlinePlain: "Reach IBM Db2 / IBM Database users",
        headlineAccent: "with installed-base precision.",
        paragraphs: [
          "IBM Db2 / IBM Database marketing requires installed-base precision. Whether you\u2019re selling complementary tools, running a migration program, or targeting competitive displacement, the list needs to be platform-specific and role-aware.",
      "Our IBM Db2 / IBM Database user list is verified to the same standard as every Lorann file: monthly verification, opt-in compliant, and segmented by role and seniority across decision-making teams.",
        ],
      }}
      ...
      backLink={{ label: "All DBMS Users Lists", href: "/data-assets/b2b-database/technology/dbms-users-email-data" }}
    />
  );
}
