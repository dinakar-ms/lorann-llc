...
const DATA: Record<string, HubFeatures> = {
  ...
  "physicians-advanced-practice/physicians-doctors": {
    ...
    cards: [
      ...
      { icon: Cpu,                title: "EMR/EHR Platform Flags",              desc: "Identify physicians using Epic, Cerner, or Athenahealth for healthcare technology and integration marketing campaigns." },
  ...
  "physicians-advanced-practice/podiatrists": {
    ...
    cards: [
      { icon: BadgeCheck,         title: "Specialty Certification Filters",     desc: "Distinguish podiatric surgeons from medical podiatrists. ABPS fellowship-credentialed DPMs identified as a premium sub-segment." },
      ...
      { icon: ShieldCheck,        title: "DPM License Validation",              desc: "State podiatric license status cross-validated against board registries. Active and renewal-pending records clearly flagged." },
      ...
      { icon: Layers,             title: "Equipment & Supply Affiliations",     desc: "Orthotics lab relationships and DME supplier affiliations flagged for targeted supply chain and equipment vendor outreach." },
    ],
  },

  "physicians-advanced-practice/nurse-practitioners": {
    kicker: "Nurse Practitioner Data",
    headline: "Target NPs who prescribe",
    accent: "and drive clinical decisions.",
    cards: [
      { icon: SlidersHorizontal,  title: "Specialty Focus Filters",             desc: "Separate family NPs from psychiatric, acute care, and women's health NPs. Each specialty is a unique, non-overlapping audience." },
      { icon: FileText,           title: "Prescribing Authority by State",      desc: "Full prescriptive authority, collaborative practice, and restricted-practice state flags are included per NP record." },
      { icon: Building2,          title: "Practice Setting Segmentation",       desc: "Distinguish NPs in primary care from urgent care, retail clinics, hospital systems, and specialty group practices." },
      { icon: BadgeCheck,         title: "Certification & Credential Validation",desc: "ANCC and AANP certification status validated. Board renewal dates and specialty endorsements included per record." },
      { icon: Users,              title: "Patient Panel Size Indicators",       desc: "High-volume NP practices with large active patient panels flagged for pharmaceutical and device representative priority outreach." },
      { icon: Cpu,                title: "Telehealth Provider Flags",           desc: "NPs actively providing telehealth consultations flagged for health technology and virtual care platform marketing." },
    ],
  },

  "physicians-advanced-practice/physician-assistants": {
    kicker: "Physician Assistant Data",
    headline: "PA data built for",
    accent: "specialty and surgical outreach.",
    cards: [
      { icon: Stethoscope,        title: "Specialty Practice Area Filters",     desc: "Reach PAs in surgery, emergency medicine, orthopedics, and primary care as distinct, validated audience sub-segments." },
      { icon: ShieldCheck,        title: "Surgical First-Assist Flags",         desc: "PAs credentialed as surgical first assistants identified and flagged for instrumentation and supply vendor outreach." },
  ...
  "physicians-advanced-practice/medical-assistants": {
    ...
    headline: "Reach clinical MAs",
    accent: "across every specialty setting.",
    cards: [
      { icon: BadgeCheck,         title: "Credential Type Segmentation",        desc: "Separate CMAs (AAMA), RMAs (AMT), and NHCEAs into distinct, validated credential sub-segments for targeted outreach." },
      ...
      { icon: Cpu,                title: "EMR Proficiency Flags",               desc: "MAs trained in specific EHR platforms identified for healthcare IT and training product marketing campaigns." },
  ...
  "nursing-professionals/registered-nurses": {
    ...
    headline: "RN data engineered for",
    ...
    cards: [
      ...
      { icon: Award,              title: "BSN vs. ADN Credential Filters",      desc: "Distinguish BSN-prepared nurses from ADN-credentialed RNs for education-level and career-stage targeted messaging." },
      { icon: Building2,          title: "Hospital System Affiliation",         desc: "Reach RNs at specific health systems, IDN networks, or independent hospital facilities by name or region." },
      { icon: Users,              title: "Travel Nurse Indicators",             desc: "Travel and agency RNs flagged and segmented for staffing firms, recruiters, and continuing education providers." },
      { icon: Star,               title: "Magnet Hospital Designation Flags",   desc: "RNs at Magnet-designated facilities identified. Target high-acuity, evidence-based practice environments for premium messaging." },
  ...
  "nursing-professionals/licensed-practical-nurses": {
    ...
    headline: "LPN data built for",
    accent: "long-term care and clinic outreach.",
    cards: [
      { icon: Building2,          title: "Care Setting Segmentation",           desc: "Distinguish LPNs in long-term care, assisted living, home health, physician offices, and correctional facilities." },
      { icon: SlidersHorizontal,  title: "State Scope-of-Practice Flags",       desc: "Medication administration and IV therapy scope vary by state — each record includes applicable state-level permission flags." },
      { icon: BadgeCheck,         title: "Specialty Certification Data",         desc: "Wound care, IV therapy, and gerontology specialty certifications for LPNs flagged and validated per record." },
      { icon: Layers,             title: "Facility Ownership Type",              desc: "Reach LPNs at for-profit chains, nonprofit SNFs, and government-run facilities as separate addressable audiences." },
      { icon: ShieldCheck,        title: "NCLEX-PN License Validation",          desc: "Active LPN licensure verified against all 50 state nursing boards. Renewal-pending and compact holders identified." },
      { icon: ClipboardList,      title: "CE & License Renewal Targeting",       desc: "LPN CEU and renewal schedules available for education providers and conference marketing campaigns." },
    ],
  },

  "nursing-professionals/certified-nursing-assistants": {
    kicker: "Certified Nursing Assistant Data",
    headline: "CNA data for",
    accent: "SNF and home health outreach.",
    cards: [
      { icon: Building2,          title: "Facility Type Segmentation",           desc: "Reach CNAs in SNFs, assisted living, memory care, home health agencies, and hospital settings as distinct audiences." },
      { icon: ShieldCheck,        title: "State Registry Validation",            desc: "CNA certifications cross-verified against state nurse aide registries. Active, lapsed, and provisional certifications coded." },
      { icon: BadgeCheck,         title: "Specialty Certification Flags",        desc: "CNAs holding dementia care, feeding assistant, and restorative aide certifications identified for targeted supply marketing." },
      { icon: Layers,             title: "Facility Size & Chain Affiliation",    desc: "Identify CNAs at large chain SNF operators vs. independent facilities for account-level territory planning." },
      { icon: SlidersHorizontal,  title: "Geographic Concentration Data",        desc: "CNA density by ZIP code and county available for home health agency recruiting and training program marketing." },
      { icon: Users,              title: "Language & Bilingual Flags",           desc: "Bilingual CNA records identified where available. Useful for staffing agencies and multi-language training content marketing." },
    ],
  },

  "nursing-professionals/certified-nurse-midwives": {
    kicker: "Certified Nurse-Midwife Data",
    headline: "CNM data for precision",
    accent: "women's health outreach.",
    cards: [
      { icon: Building2,          title: "Practice Setting Segmentation",        desc: "Separate CNMs in hospital birth centers, freestanding birth centers, and home birth practices into distinct segments." },
      ...
      { icon: Cpu,                title: "Telehealth Prenatal Provider Flags",    desc: "CNMs offering virtual prenatal consultations flagged for health technology, app, and telehealth platform outreach." },
    ],
  },
  ...
  "hospital-decision-makers/hospital-administrators": {
    ...
    cards: [
      { icon: Users,              title: "Administrative Role Hierarchy",         desc: "Segment administrators by VP, Director, Manager, and Coordinator levels for authority-matched outreach campaigns." },
      ...
      { icon: Cpu,                title: "Technology Platform Data",              desc: "Current EHR, HIS, and supply chain platform usage flagged per facility for healthcare IT and SaaS outreach." },
    ],
  },
  ...
  "hospital-decision-makers/ceo-cfo-healthcare": {
    ...
    cards: [
      { icon: Star,               title: "Executive Title & Authority Level",     desc: "Separate hospital CEOs from CFOs, COOs, and system-level presidents. Each title carries distinct budget and contract authority." },
  ...
  "hospital-decision-makers/chief-medical-officers": {
    ...
    headline: "CMO data for clinical",
    accent: "and enterprise vendor outreach.",
    cards: [
      { icon: Building2,          title: "System vs. Hospital CMO Distinction",   desc: "Health system-level CMOs hold broader authority than facility CMOs — both are segmented and flagged independently." },
      ...
      { icon: BadgeCheck,         title: "Board Certification Validation",         desc: "CMOs holding active clinical board certifications flagged. Relevant for pharma and device companies seeking peer-level engagement." },
      { icon: ShieldCheck,        title: "Quality & Accreditation Focus",          desc: "CMOs at hospitals with recent Joint Commission or CMS accreditation activity flagged for quality and compliance vendors." },
      { icon: Award,              title: "Graduate Medical Education Ties",        desc: "CMOs at teaching hospitals and GME-affiliated facilities flagged for medical education and residency program vendors." },
      { icon: FileText,           title: "Publication & Research Activity",        desc: "Clinically publishing CMOs identified for academic and clinical evidence-based marketing approaches." },
    ],
  },

  "hospital-decision-makers/chief-nursing-officers": {
    kicker: "Chief Nursing Officer Data",
    headline: "CNO data for nursing",
    accent: "workforce and quality vendors.",
    cards: [
      { icon: Building2,          title: "System-Level vs. Facility CNO",         desc: "CNOs overseeing nursing strategy at multi-hospital system level segmented from facility-level Chief Nursing Officers." },
      { icon: Star,               title: "Magnet & Excellence Program Flags",      desc: "CNOs at Magnet-designated and Pathway to Excellence hospitals flagged for nursing practice and quality product vendors." },
      { icon: Award,              title: "ANCC & AONL Affiliation Flags",          desc: "CNOs with American Nurses Credentialing Center and AONL membership and leadership roles identified." },
      ...
      { icon: ClipboardList,      title: "Graduate Nursing Education Background",  desc: "CNOs with DNP or PhD credentials identified for clinical decision-support and advanced nursing education marketing." },
      { icon: Layers,             title: "Board & Committee Roles",                desc: "CNOs serving on state nursing boards, ethics committees, or hospital governance bodies flagged for leadership-level engagement." },
    ],
  },
  ...
  "health-therapy/physical-therapists": {
    ...
    headline: "PT data that reaches",
    accent: "every specialty and practice setting.",
    cards: [
      { icon: Activity,           title: "Specialty Practice Focus",              desc: "Distinguish orthopedic PTs from neurological, pediatric, sports, and cardiovascular specialists. Each segment is non-overlapping." },
      { icon: Building2,          title: "Practice Setting Filters",              desc: "Separate outpatient clinic, acute care hospital, SNF, home health, and private practice PTs into distinct audiences." },
      ...
      { icon: SlidersHorizontal,  title: "Patient Volume Indicators",             desc: "High-volume PT clinics treating 25+ patients daily flagged for supply, equipment, and EMR vendor priority targeting." },
      { icon: Star,               title: "Dry Needling & Technique Flags",        desc: "PTs certified in dry needling, aquatic therapy, and manual therapy techniques identified for specialized product outreach." },
      { icon: Cpu,                title: "Telehealth PT Providers",               desc: "PTs offering virtual physical therapy flagged for digital health platform and remote exercise technology marketing." },
    ],
  },

  "health-therapy/occupational-therapists": {
    kicker: "Occupational Therapist Data",
    headline: "OT data for adaptive",
    accent: "equipment and CE outreach.",
    cards: [
      { icon: Building2,          title: "Practice Setting Segmentation",         desc: "Separate OTs in school districts, acute care, outpatient, SNF, hand therapy clinics, and mental health settings." },
      ...
      { icon: Award,              title: "Specialty Certification Flags",         desc: "OTs with BCPR, CHT, and other specialty certifications validated for the highest-credentialed OT segment." },
      { icon: SlidersHorizontal,  title: "Pediatric vs. Geriatric Population",    desc: "OTs treating pediatric populations segmented from adult and geriatric-focused practitioners for product alignment." },
      { icon: ClipboardList,      title: "Adaptive Equipment Prescribers",        desc: "OTs who regularly prescribe adaptive equipment and AT devices flagged for DME and assistive technology vendors." },
  ...
  "health-therapy/speech-language-therapists": {
    ...
    headline: "SLP data for AAC,",
    accent: "dysphagia, and CE outreach.",
    cards: [
      { icon: SlidersHorizontal,  title: "Specialty Focus Segmentation",          desc: "Reach SLPs specializing in dysphagia, AAC, pediatric language, voice disorders, and fluency as distinct clinical sub-audiences." },
      { icon: Building2,          title: "Practice Setting Filters",              desc: "Distinguish school-based SLPs from acute care, outpatient, SNF, private practice, and early intervention program settings." },
      { icon: BadgeCheck,         title: "ASHA CCC Certification Validation",     desc: "CCC-SLP certification status verified against ASHA records. Clinical Fellows and associate-level SLPs also flagged." },
      { icon: Users,              title: "Pediatric vs. Adult Population Focus",   desc: "SLPs with primarily pediatric caseloads segmented from adult neurological rehab and geriatric swallowing disorder specialists." },
      { icon: Cpu,                title: "AAC Device & Technology Prescribers",   desc: "SLPs certified in AAC device prescription flagged for assistive technology vendor targeting." },
      { icon: Activity,           title: "Telepractice Provider Flags",           desc: "SLPs actively delivering services via telepractice platforms flagged for telehealth software and remote therapy tool vendors." },
    ],
  },

  "health-therapy/respiratory-therapists": {
    kicker: "Respiratory Therapist Data",
    headline: "RT data for ventilator",
    accent: "and pulmonary care outreach.",
    cards: [
      { icon: Building2,          title: "Setting & Acuity Level Segmentation",   desc: "Separate critical care RTs in ICU/NICU from home care, pulmonary rehab, and sleep lab respiratory therapist segments." },
      { icon: SlidersHorizontal,  title: "Credential Level Filters",              desc: "Distinguish Registered Respiratory Therapists (RRT) from Certified Respiratory Therapists (CRT) by scope and autonomy." },
      { icon: BadgeCheck,         title: "NBRC Certification Validation",         desc: "RRT, RPSGT, and specialty credential status verified against NBRC records. Renewal-pending records flagged per state." },
      { icon: Activity,           title: "Advanced Ventilator Competency Flags",  desc: "RTs with advanced ventilator, ECMO, and oscillator competency documented for high-acuity equipment vendors." },
      { icon: Star,               title: "Sleep Disorder & RPSGT Flags",          desc: "RTs working in sleep labs or holding RPSGT credentials segmented for CPAP, PAP device, and sleep technology vendors." },
      { icon: Layers,             title: "Home Respiratory Care Providers",       desc: "RTs working in home health or DME environments flagged for home oxygen, portable ventilator, and nebulizer supply outreach." },
    ],
  },

  "health-therapy/massage-therapists": {
    kicker: "Massage Therapist Data",
    headline: "LMT data for supply",
    accent: "and practice management outreach.",
    cards: [
      { icon: Award,              title: "Specialty Technique Certification",     desc: "Distinguish LMTs certified in deep tissue, sports, lymphatic drainage, prenatal, and medical massage as separate segments." },
      { icon: Building2,          title: "Practice Setting Filters",              desc: "Separate LMTs in clinical/chiropractic co-located practices from spa, resort, sports medicine, and independent settings." },
      ...
      { icon: Activity,           title: "High-Volume Practice Indicators",       desc: "LMTs with high appointment volume (20+ weekly sessions) flagged for massage table, supply, and practice management vendors." },
      { icon: ClipboardList,      title: "Insurance-Billing Eligible Therapists", desc: "LMTs in states where massage is covered under health plans or FSA/HSA flagged for billing and insurance marketing." },
      { icon: RefreshCw,          title: "CE Renewal Targeting",                  desc: "LMTs approaching CE renewal periods identified for CE provider, advanced technique, and certification marketing." },
    ],
  },
  ...
  "health-therapy/dieticians-nutritionists": {
    ...
    headline: "RD data for clinical",
    accent: "nutrition and wellness outreach.",
    cards: [
      { icon: BadgeCheck,         title: "RD vs. DTR Credential Segmentation",    desc: "Separate Registered Dietitians (RDN) from Dietetic Technicians Registered (DTR) and unlicensed nutritionists by state." },
      { icon: Building2,          title: "Practice Setting Filters",              desc: "Reach RDs in clinical, outpatient counseling, public health, sports nutrition, corporate wellness, and private practice." },
      ...
      { icon: SlidersHorizontal,  title: "Clinical vs. Community Nutrition",      desc: "RDs in medical nutrition therapy roles segmented from community, school, and public health nutrition program positions." },
      { icon: Cpu,                title: "Telehealth Nutrition Counseling Flags", desc: "RDs providing virtual medical nutrition therapy flagged for telehealth, billing software, and meal-planning tool vendors." },
    ],
  },
  ...
  "behavioral-mental-health": {
    ...
    cards: [
      { icon: Brain,              title: "Credential-Level Filtering",  desc: "Reach PhDs, LCSWs, LMFTs, LPCs, and psychiatrists as separate audiences. Each carries distinct prescribing and referral authority." },
  ...
  "behavioral-mental-health/psychologists": {
    ...
    headline: "PhD and PsyD data for",
  ...
  "behavioral-mental-health/mental-health-counselors": {
    ...
    headline: "LPC and LMHC data for",
    accent: "practice and technology outreach.",
    cards: [
      { icon: SlidersHorizontal,  title: "License Type Segmentation",             desc: "Separate LPCs, LMHCs, LADCs, and LCPCs by state-specific designation. Each maps to distinct scope and population focus." },
      ...
      { icon: ClipboardList,      title: "Insurance Panel & Credentialing Status", desc: "Counselors accepted on major insurance panels flagged. Ideal for EHR, billing, and practice management software marketing." },
      { icon: Cpu,                title: "Telehealth Counseling Providers",        desc: "LPCs and LMHCs actively providing virtual counseling flagged for telehealth, scheduling, and mental health app outreach." },
    ],
  },

  "behavioral-mental-health/social-workers": {
    kicker: "Social Worker Data",
    headline: "LCSW data for clinical",
    accent: "and community outreach.",
    cards: [
      { icon: SlidersHorizontal,  title: "License Level Segmentation",            desc: "Separate LSWs, LCSWs, LMSWs, and macro social workers by license designation for relevant outreach alignment." },
  ...
  "behavioral-mental-health/marriage-family-therapists": {
    ...
    headline: "LMFT data for practice",
    accent: "and continuing education outreach.",
    cards: [
      { icon: SlidersHorizontal,  title: "License Type by State",                  desc: "Distinguish LMFTs, MFCs, and MFTs by state designation. Practice scope and supervision requirements vary by jurisdiction." },
      ...
      { icon: Building2,          title: "Private Practice vs. Agency Setting",     desc: "Independently practicing LMFTs segmented from agency-employed therapists in community, school, and hospital-affiliated roles." },
      { icon: ClipboardList,      title: "Insurance Panel Participation Flags",     desc: "LMFTs accepted on major insurance panels identified for billing, credentialing, and practice management software outreach." },
    ],
  },
  ...
  "dental-vision/optometrists": {
    ...
    headline: "OD data for lens",
    accent: "pharmaceutical and device outreach.",
    cards: [
      { icon: Eye,                title: "Therapeutic vs. Diagnostic Scope",       desc: "ODs with therapeutic prescribing authority for medications segmented from diagnostic-only scope practitioners." },
      ...
      { icon: Award,              title: "AOA Membership & Accreditation Data",    desc: "AOA member optometrists and ACOE school graduates flagged for association-adjacent pharmaceutical and supply outreach." },
      { icon: Building2,          title: "Solo vs. Corporate Practice",            desc: "Independent ODs segmented from franchise-setting and retail-optical-setting-employed optometrists." },
      { icon: SlidersHorizontal,  title: "High-Volume Contact Lens Practice",      desc: "Optometrists fitting 20+ new contact lens patients weekly flagged for CL manufacturer and solution supply targeting." },
      { icon: Stethoscope,        title: "Ocular Disease Management Focus",        desc: "ODs with glaucoma, dry eye, and diabetic retinopathy co-management protocols flagged for pharmaceutical and device vendors." },
    ],
  },
  ...
  "pharmacy-practice-management/pharmacists": {
    ...
    accent: "PBM and supply outreach.",
    cards: [
  ...
  "pharmacy-practice-management/physician-practice-managers": {
    ...
    accent: "EHR supply and operations outreach.",
    cards: [
      ...
      { icon: Cpu,                title: "EHR & Practice Management Platform Flags", desc: "Current EHR and PM software in use at the practice flagged. Ideal for software vendor competitive displacement campaigns." },
  ...
  "specialty-other/chiropractors": {
    ...
    headline: "DC data for technique",
    accent: "and equipment-specific outreach.",
    cards: [
      { icon: SlidersHorizontal,  title: "Technique Specialization Flags",        desc: "Reach DCs certified in Gonstead, Diversified, SOT, Activator, and Cox Flexion as distinct technique-based sub-segments." },
      ...
      { icon: ShieldCheck,        title: "State License & NBCE Validation",       desc: "Active chiropractic licensure verified against state boards and NBCE records. License renewal cycle and CE status included." },
      { icon: Award,              title: "Adjunct Therapy Certifications",         desc: "DCs with acupuncture, kinesiology taping, and physical rehabilitation certifications flagged for complementary supply vendors." },
  ...
  "specialty-other/veterinarians": {
    ...
    cards: [
      ...
      { icon: Award,              title: "AVMA & State VMA Membership Flags",       desc: "AVMA member DVMs and state VMA members identified for association-adjacent pharmaceutical and supply marketing." },
      ...
      { icon: Layers,             title: "Large Animal & Production Focus",         desc: "DVMs serving cattle, swine, poultry, and aquaculture production operations segmented for production animal drug vendors." },
    ],
  },
  ...
  "specialty-other/allied-healthcare-professionals": {
    ...
    cards: [
      ...
      { icon: SlidersHorizontal,  title: "Specialty Certification Flags",          desc: "Advanced credentials within each discipline (CLS generalist vs. specialist, RRT vs. CRT) flagged for appropriate tier messaging." },
